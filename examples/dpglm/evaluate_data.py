...
if SIN:
    x_categories = ['250', '500', '750', '1000', '1500']
    n_train_arr = [250, 500, 750, 1000, 1500]
    in_dim_niw = 1
    out_dim = 1
...
if kin_1joint:
    x_categories = ['30', '100', '250', '500', '1000']
    n_train_arr = [30, 100, 250, 500, 1000]
    in_dim_niw = 1
    out_dim = 2
...
if kin_3joint:
    x_categories = ['500', '1000', '1500', '2000', '2500']
    n_train_arr = [500, 1000, 1500, 2000, 2500]
    in_dim_niw = 3
    out_dim = 2
...
for e in range(eval_iter):
    ...
    print('eval_iter',e)
    if e == 0:
        n_train = n_train_arr[0]
    elif e == 1:
        n_train = n_train_arr[1]
    elif e == 2:
        n_train = n_train_arr[2]
    elif e == 3:
        n_train = n_train_arr[3]
    elif e == 4:
        n_train = n_train_arr[4]
