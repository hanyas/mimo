...
if __name__ == "__main__":
    ...
    mu_predict, var_predict, std_predict, _ =\
        dpglm.parallel_meanfield_prediction(trans_input, prediction=args.prediction)
    ...
    sorted_input, sorted_trans_input, sorted_target = input[sorter, 0], trans_input[sorter, :], target[sorter, 0]
